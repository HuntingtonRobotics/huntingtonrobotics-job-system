...
class OneFileLoginApplication
{
    ...
    private function showPageLoginForm()
    {
        ...
        echo '<label for="login_input_username">Username (or phone number)  </label>';
		...
		echo '<p>You must register</p><a href="' . $_SERVER['SCRIPT_NAME'] . '?action=register">Register new account</a>';
		//echo '</center>';
    }
