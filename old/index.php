			...
			if ($result) {
				...
				foreach ($result as $entry) {
					if ($entry['job_accepted'] == 0) {
						echo "<tr><td>" . $entry["job_desc"] . "</td><td>" . $entry["time_sent"] . "</td><td> - </td><td> - </td><td>" . $entry["sent_by"] . "</td><td> - </td><td><form method='post' action='' name='acceptform'><input type='hidden' name='job_id' value='" . $entry['job_id'] . "' /><input type='submit' name='accept' value='Accept Job' /></form></td></tr>";
